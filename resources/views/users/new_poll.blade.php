...
@section('content')
    ...
    <div class=" w-100 px-5 d-flex justify-content-center">
        <form class=" w-75 text-justify mt-5">
            ...
            <div id="ops">
                <div class=" my-2 " >
                    <input type="text" class="w-100 form-control bg-light border-2  p-2 choise " name="choise1" id="choise1" placeholder="گزینه اول در مورد این میباشد که ...">
                </div>
            </div>
    ...
    <script>
        ...
        btn.addEventListener('click', function() {
            ...
            <div class=" my-2 " >
                <input type="text" class="w-100 form-control bg-light border-2  p-2 choise " name="choise${i}" placeholder="این گزینه در مورد این میباشد که ...">
            </div>` ;
            i=i+1;
        });
